...
class _PlayVideoPageState extends State<PlayVideoPage> {
            ...
            child: Scaffold(
              ...
              body: Stack(
                ...
                children: [
                  ...
                  // Always show controls (even without video for URL input)
  ...
  Widget _buildMaterialControls(VideoPlayerState videoState) {
    // Simplified - only show the modern controls overlay
    return const VideoControlsOverlay();
  }
  ...
  Future<void> _showSendDanmakuDialog(VideoPlayerState videoState) async {
    ...
    // Danmaku feature removed - not needed in simplified player
    /*
